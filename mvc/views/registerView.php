    ...
    <div class="main">
        <form method="POST" class="form" id="form-1" action="login/register">
            ...
            <div class="form-group">
                ...
                <input id="fullname" name="member_name" type="text" placeholder="Enter your fullname..."
                    class="form-control">
            ...
            <div class="form-group">
                ...
                <input id="email" name="member_email" type="email" placeholder="Enter your email..."
                    class="form-control">
                <span class="form-message"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="password" name="member_password" type="password" placeholder="Enter password..."
                    class="form-control">
                <span class="form-message"></span>
            </div>
