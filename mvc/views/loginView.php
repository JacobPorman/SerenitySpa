...
<body>
    <div class="main">
        <form method="post" class="form" id="form-2" action="<?php echo getUrl() . "/login/auth" ?>">
        ...
        {{/if}} -->
            ...
            <div class="form-group">
                ...
                <input id="email" name="email" type="email" aria-describedby="emailHelp" placeholder="Enter your email..." class="form-control" required>
            ...
            <a href="<?php echo getUrl() . "/login/registerView" ?>" class='desc'>Register now!</a>
